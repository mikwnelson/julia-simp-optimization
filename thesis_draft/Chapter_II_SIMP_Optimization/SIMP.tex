...
\begin{enumerate}
	...
	\item The heat generating materials ($k_0$) and high-conductivity materials ($k_+$) are treated as {\color{baystate}homogeneous} and {\color{baystate}isotropic} on their respective conductivities.
\end{enumerate}
