...
\begin{equation}
	\begin{tabular}{ll}
		...
		\text{subject to } & $\mathbf{K}\mathbf{T}=\mathbf{Q}$                                                                   \\
		                   & $\displaystyle\frac{1}{N_{\boldsymbol{\eta}}}\sum_{i=1}^{mn}\boldsymbol{\eta}_i\leq\overline{\phi}$ \\
		                   & $\mathbf{k}=k_0\vec{\mathbf{1}}+(k_+-k_0)\boldsymbol{\eta}^p$                                       \\
